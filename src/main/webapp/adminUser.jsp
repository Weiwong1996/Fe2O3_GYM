	...
	<div class="container-fluid">
		<div class="row">
			<div class="btn-group-vertical col-sm-2 " role="group">
				<div class="btn-group">
					<button onclick="javascript:location.href='adminCtrl/userManage'" class="btn btn-primary btn-lg dropdown-toggle"
							...
							<tr class="trfontsize">
								...
								<td>
        								...
        								document.getElementById('fade').style.display='block'"
											...
											<a href="adminCtrl/deleteUsers1?uid=${u.uid}"
	...
	<div id="light1" class="white_content">
		<div class="page ">
			<div class="banneradd bor">
				...
				<form method="get" class="form-horizontal"
					action="adminCtrl/editUser1?uid=${u.uid}">
