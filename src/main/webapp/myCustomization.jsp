				...
				<div class="sBox">
					...
					<ul class="navContent" style="display: block">
						...
						<li class="active">
							...
							</div> <a href="customization.html"><span
								class="sublist-icon glyphicon glyphicon-user"></span><span
			...
			<div class="container-fluid">
				<div class="info-center">
					...
					<div class="info-center-title">
						<span class="padding-large-right pull-left"> <a
							href="customization/show1?uid=${uid}">全部消息</a>
						</span> <span class="padding-large-right manage-title pull-left"><a
							class="active" href="#">我的定制</a></span>
					</div>
					...
					<div class="table-margin">
						<table class="table table-bordered table-header">
							<thead>
								<tr align="center">
									<td class="w50">自定义定制内容</td>
									<td class="w15">我的教练ID</td>
									<td class="w15">价格</td>
								</tr>
							</thead>
							<tbody>

								<c:forEach var="cu" items="${clist}">
									<tr align="center">
										<td>${cu.cuscontent}</td>
										<td>${cu.cid}</td>
										<td>${cu.cusprice}元</td>
