			  	...
			  	$.ajax({
					...
					success: function(data){
						...
						$.each(data, function(i,n) {
							var sid = data[i].sid;
							var scontent = data[i].scontent;
							var sdiscount = data[i].sdiscount;
							var sprice = data[i].sprice;				
							var b='<a href="onsaleCtrl/delPro?cid='+sid+'" class="btn btn-danger">删除</a>';
							var Salelist = "<tr><th>"+sid+"</th><th>"+scontent+"</th><th>"+sdiscount+"</th><th>"+sprice+"</th><th>"+b+"</th></tr>";
							$("#info tr:eq(0)").after(Salelist);	
						});
					},
					 async:true 
				});
								...
								<td>
									<div class="btn-group">
										<a href="" class="btn btn-default">修改</a><a href=""
											class="btn btn-default">下架</a><a href=""
